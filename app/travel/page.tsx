      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <p className={styles.intro}>
            Official Akbar Travels partner. Flight bookings, international visa processing,
            and customized holiday packages handled with complete professional care.
          </p>
        </div>
      </section>

      {/* Interactive Section (White Cards on Left + Form on Right) */}
      <section className={styles.splitSection} aria-label="Travel services selection and enquiry">
        <div className={styles.splitContainer}>
