...
const SERVICES = [
  { key: 'motherboard', icon: Cpu, heading: 'Motherboard & Chip-Level Repair', line: 'BGA rework & component-level diagnostics. We repair the board instead of expensive replacement.' },
  ...
  { key: 'printer', icon: Printer, heading: 'Printer Service', line: 'Laser, inkjet, and tank printers. Canon, Epson & HP drum, head, and feed repairs.' },
  { key: 'data-recovery', icon: HardDrive, heading: 'Data Recovery', line: 'Logical and hardware recovery from damaged SSDs, hard drives, and flash media.' },
  { key: 'amc', icon: FileCheck, heading: 'Annual Maintenance (AMC)', line: 'Scheduled preventive care, routine check-ups, and emergency support for institutions.' },
  { key: 'os-software', icon: Terminal, heading: 'OS & Software Solutions', line: 'OS installations, data backup, licensing, malware removal, and speed tuning.' },
  { key: 'on-site', icon: Building2, heading: 'On-Site Field Service', line: 'Direct technician visits for offices, clinics, and schools across Trivandrum district.' },
  { key: 'other', icon: Wrench, heading: 'Other Electronics', line: 'UPS, stabilizers, power supplies, networking switches, and peripheral repair.' },
];
        ...
        <div className={styles.splitGrid}>
          ...
          <div className={styles.leftColumn}>
            ...
            <p className={styles.intro}>
              ...
              It has been our core specialty in Kallara since 2016, saving customers up to 70% in repair costs.
            </p>
                ...
                return (
                  ...
                  >
                    <div className={styles.serviceIconWrapper}>
                      <Icon size={20} strokeWidth={2} className={styles.serviceIconSvg} aria-hidden="true" />
                    </div>
