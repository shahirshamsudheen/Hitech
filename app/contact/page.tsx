...
import { MapPin, Phone, Smartphone, PhoneCall, Clock, MessageCircle } from 'lucide-react';
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <p className={styles.intro}>
            Call, WhatsApp or drop by our Kallara office. Our desk responds within one working day.
          </p>
        </div>
      </section>

      {/* Interactive Section (Info + Map on Left, Form on Right) */}
      <section className={styles.splitSection} aria-label="Contact information and message form">
        <div className={styles.splitContainer}>
          <div className={styles.splitGrid}>
            ...
            <div className={styles.leftColumn}>
              ...
              <div className={styles.phonesContainer}>
                <a href="tel:+919496818237" className={styles.phoneCard}>
                  ...
                  <div className={styles.phoneCardContent}>
                    ...
                    <span className={styles.phoneRole}>WhatsApp / Primary</span>
                  </div>
                </a>
              ...
              <div className={styles.miscRow}>
                <a href={buildWhatsAppUrl()} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp">
